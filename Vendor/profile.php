	...
	<div class="row clearfix">
		<!-- <div class="col-md-12 column"> -->
            <div>
                ...
                <h2 class="text-center profile-text profile-profession"><?php echo $rws['user_servicetype'];?></h2>
                <br>
                        ...
                        <div id="panel-element-info" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <div class="col-md-8 column">
                                    ...
                                    <hr>
<?php
    if ($rws['user_description']){
?>   
                                    <div class="col-md-4">
                                        <p class="profile-details"><i class="fa fa-info"></i> Description</p>
                                    </div>
                                    <div class="col-md-8">
