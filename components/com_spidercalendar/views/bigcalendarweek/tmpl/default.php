              ...
              <table  cellpadding="0" cellspacing="0" border="0" style="border-spacing:0; font-size:12px; margin:0; padding:0;  width:100%;"  >
                ...
                <tr  style="height:40px; width:100%;">
                   ...
                   <table cellpadding="0" cellspacing="0" border="0" align="center" class="calyear_table"  style="margin:0; padding:0; text-align:center; width:100%; height:<?php echo $top_height ?>px;">
								...
								<td width="15%">
								<div onclick="javascript:showbigcalendar( 'bigcalendar<?php echo $id ?>','<?php echo JRoute::_('index.php?option=com_spidercalendar&view=bigcalendarweek&def_view='.$defaultview.'&views='.$viewselect.'&rand='.$id.'&theme_id='.$theme_id.'&calendar='.$calendar_id.'&cat_id=&cat_ids='.$cat_ids).'&format=row&Itemid='.JRequest::getVar( "Itemid","").'&months='.$prev_month.','.$this_month.','.$next_month.'&date='.($year-1).'-'.add_0((Month_num($month))).'-'.date('d') ?>','<?php echo $id ?>')" style="cursor:pointer;width:100%; height:35px; background-color: rgba(0,0,0,0.3);"><span style="top: 25%;position: relative;font-size: 26px;color:<?php echo $bg_top ?>"><?php echo $year-1 ?></span></div>
								</td>
									...
									<a  style="text-shadow: 1px 1px 2px black;color:<?php echo $color_arrow_month ?>;"
											...
											echo JRoute::_('index.php?option=com_spidercalendar&view=bigcalendarweek&def_view='.$defaultview.'&views='.$viewselect.'&rand='.$id.'&theme_id='.$theme_id.'&calendar='.$calendar_id.'&cat_id=&cat_ids='.$cat_ids).'&format=row&Itemid='.JRequest::getVar( "Itemid","").'&date='.$prev_date.'&months='.$prev_month.','.$this_month.','.$next_month;
									...
									<td style="text-align:center; margin:0;" width="40%" >
										   ...
										   <span  style="font-family:arial; color:<?php echo $text_color_month;?>; font-size:<?php echo $month_font_size ?>px;text-shadow: 1px 1px black;"><?php echo JText::_('TAB_WEEK').' '. date('W',mktime(0, 0, 0, month_num($month), $day, $year)).', '.$year; ?></span>
									...
									<td width="15%">
								<div onclick="javascript:showbigcalendar( 'bigcalendar<?php echo $id ?>','<?php echo JRoute::_('index.php?option=com_spidercalendar&def_view='.$defaultview.'&views='.$viewselect.'&view=bigcalendarweek&rand='.$id.'&theme_id='.$theme_id.'&calendar='.$calendar_id.'&cat_id=&cat_ids='.$cat_ids).'&format=row&Itemid='.JRequest::getVar( "Itemid","").'&months='.$prev_month.','.$this_month.','.$next_month.'&date='.($year+1).'-'.add_0((Month_num($month))).'-'.date('d') ?>','<?php echo $id ?>')" style="cursor:pointer;width:100%; height:35px; background-color: rgba(0,0,0,0.3);"><span style="top: 25%;position: relative;font-size: 26px;color:<?php echo $bg_top ?>"><?php echo $year+1 ?></span></div>
								</td>
...
<li style="float:left;"><p class="categories1" style="background-color:#<?php echo $category->color;?>">&nbsp;&nbsp;&nbsp;&nbsp;</p><p class="categories2" id="category<?php echo $category->id ?>" style="color:#<?php echo $category->color?>" onclick="showbigcalendar( 'bigcalendar<?php echo $id ?>','<?php echo JRoute::_('index.php?option=com_spidercalendar&view=bigcalendarweek&def_view='.$defaultview.'&views='.$viewselect.'&rand='.$id.'&theme_id='.$theme_id.'&calendar='.$calendar_id.'&cat_id='.$category->id.'&cat_ids='.$cat_ids ).'&format=row&tmpl=component&Itemid='.JRequest::getVar( "Itemid","").'&months='.$prev_month.','.$this_month.','.$next_month.'&date='.$year.'-'.$month.'-'.$day ;?>','<?php echo $id ?>')" > <?php echo  $category->title ?></p></li>
