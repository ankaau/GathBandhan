...
* @license		http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
    */
    ...
    class spCirclehovereffectsSliderHelper
    {
        public $name = 'Element';
        public $uniqid   = 'Circlehovereffects';
        public $fieldname;
        public $params;
        public function setOptions()
        {
            ...
            $html[] = array(
			 ...
			 $html[] = array(
                ...
                'attrs'=>'',
                'fieldname'=>'intotext',
                'html'=>'<input ref="title" type="text"  value="'.$this->params['intotext'].'"   
                name="jform[params]['.$this->fieldname.']['.$this->uniqid.'][intotext][]">'
            );
			$html[] = array(
                'title'=>'readmore info',
                'tip'=>'readmore info',
                'tipdesc'=>'readmore info text',
                'class'=>$this->uniqid.'-slider-title-li',
                'attrs'=>'',
                'fieldname'=>'readmoreinfo',
                'html'=>'<input ref="title" type="text"  value="'.$this->params['readmoreinfo'].'"   
                name="jform[params]['.$this->fieldname.']['.$this->uniqid.'][readmoreinfo][]">'
            );
			$html[] = array(
                'title'=>'Link',
                'tip'=>'Link',
